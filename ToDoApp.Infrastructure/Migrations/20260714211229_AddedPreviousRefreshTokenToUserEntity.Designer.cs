...
namespace ToDoApp.Infrastracture.Migrations
{
    ...
    [Migration("20260714211229_AddedPreviousRefreshTokenToUserEntity")]
    partial class AddedPreviousRefreshTokenToUserEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToDoApp.Domain.Entities.ToDoTaskStep", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ToDoApp.Domain.Entities.ToDoTaskStep", b =>
                {
                    b.HasOne("ToDoApp.Domain.Entities.ToDoTask", "ToDoTask")
                        .WithMany("Steps")
